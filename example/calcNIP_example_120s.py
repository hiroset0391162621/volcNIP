...
if __name__ == '__main__':
    ...
    ax5 = plt.axes([x_lim,0.07,0.3,0.15])   
    ax5.plot(nip_mean, Fv[:,0], lw=1.5, ls='--', color='C0', label='NIP (mean)', zorder=2)
    ax5.plot(nip_eightyper, Fv[:,0], lw=1.5, color='C1', label='NIP (80th percentile)', zorder=2)
    ax5.set_ylim(0.05,10)
    ax5.set_yscale('log')
    ax5.set_xlabel('NIP', fontsize=12)
    ax5.set_ylabel('Frequency [Hz]', fontsize=12)
